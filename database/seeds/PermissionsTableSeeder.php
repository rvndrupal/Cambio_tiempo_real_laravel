...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Products
         ...
         //Editables
         Permission::create([
            'name' => 'Navegar Editables',
            'slug' => 'editables.index',
            'description'  => 'Lista y navega todos los editables del sistema',

        ]);

        Permission::create([
            'name' => 'Ver detalle de editables',
            'slug' => 'editables.show',
            'description'  => 'Ver en detalle cada Editables del sistema',

        ]);

        Permission::create([
            'name' => 'Crea un nuevo Editables',
            'slug' => 'editables.create',
            'description'  => 'Crear un nuevo Editables del sistema',

        ]);

        Permission::create([
            'name' => 'Edicion de editables',
            'slug' => 'editables.edit',
        ...
        Permission::create([
            'name' => 'Eliminar Editables',
            'slug' => 'editables.destroy',
            'description'  => 'Eliminar cualquier dato de un Editables del sistema',
